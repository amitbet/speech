(function(window){
	...
	// Defaults
	var SERVER = "ws://localhost:9099/client/ws/speech";
	var SERVER_STATUS = "ws://localhost:9099/client/ws/status";
	var REFERENCE_HANDLER = "http://localhost:9099/client/dynamic/reference";
